...
KEYWORDS = {
    ...
    # --- 나가는 ↔ 머무는 (6) ---
    "주말엔 무조건 외출":   {"EI": 2, "VQ": 1, "WD": 1},
    "약속으로 꽉 찬 주말":  {"EI": 2, "TP": 1, "VQ": 1},
    "핫플 카페 도장 깨기":  {"EI": 1, "WD": 1, "VQ": 1},
    "완벽한 집순이 집돌이": {"EI": -2, "VQ": -1, "TP": -1},
    "퇴근하면 바로 귀가":   {"EI": -2, "TP": -1, "WD": -1},
    "내 방이 최고의 힐링":  {"EI": -2, "TP": -1, "VQ": -1},

    # --- 번화한 ↔ 조용한 (8) ---
    "슬리퍼 신고 쇼핑몰":   {"VQ": 2, "EI": 1, "WD": 1},
    "맛집 탐방이 일상":     {"VQ": 2, "WD": 1, "TP": 1},
    "24시간 밝은 거리":     {"VQ": 2, "EI": 1, "TP": -1},
    "지하철역이 코앞":      {"VQ": 2, "WD": 1, "EI": 1},
    "소음 없는 한적한 곳":  {"VQ": -2, "EI": -1, "TP": -1},
    "흙길 따라 걷는 산책":  {"VQ": -2, "WD": 1, "EI": 1},
    "창문 열면 녹지":     {"VQ": -2, "TP": -1, "WD": -1},
    "공원이 앞마당인 집":   {"VQ": -2, "EI": 1, "WD": 1},

    # --- 어울리는 ↔ 혼자인 (6) ---
    "단골집 사장님과 수다": {"TP": 2, "WD": 1, "VQ": 1},
    "오가며 인사하는 이웃": {"TP": 2, "VQ": -1, "WD": 1},
    "동네 모임이 활발한":   {"TP": 2, "EI": 1, "WD": 1},
    "혼자만의 고요한 시간": {"TP": -2, "EI": -1, "VQ": -1},
    "마주칠 일 없는 동네":  {"TP": -2, "VQ": -1, "EI": -1},
    "조용히 지내고 싶은":   {"TP": -2, "VQ": -1, "EI": -1},

    # --- 걷는 ↔ 타는 (6) ---
    "모든 걸 걸어서 해결":  {"WD": 2, "VQ": 1, "EI": 1},
    "1분 컷 편의점 필수":   {"WD": 2, "VQ": 1, "EI": -1},
    "장 보러 걸어가는 길":  {"WD": 2, "TP": 1, "VQ": -1},
    "주차 걱정 없는 동네":  {"WD": -2, "VQ": -1, "EI": -1},
...
# ============================================================
TYPES = {
    "EVTW": ("골목 마당발", "걸어서 번화가를 누비며 사람을 만나요"),
    "EVTD": ("약속 부자", "차를 몰고 어디든 사람 만나러 가요"),
    "EVPW": ("도심 유랑자", "북적이는 거리를 혼자 걷는 게 좋아요"),
    "EVPD": ("밤거리 드라이버", "차를 타고 혼자 도심을 돌아요"),
    "EQTW": ("동네 마실꾼", "조용한 골목을 걸으며 이웃과 인사해요"),
    "EQTD": ("주말 나들이러", "차를 타고 근교로 나가는 걸 즐겨요"),
    "EQPW": ("숲길 산책자", "혼자 걷는 조용한 길이 필요해요"),
    "EQPD": ("근교 방랑자", "훌쩍 떠나는 주말이 좋아요"),
    "IVTW": ("단골집 주인공", "집 앞 가게 사장님과 안부를 나눠요"),
    "IVTD": ("홈파티 호스트", "집으로 사람을 부르는 걸 좋아해요"),
    "IVPW": ("편의점 5분권", "필요한 게 걸어서 다 있어야 해요"),
    "IVPD": ("배달앱 마스터", "집에서 다 해결하는 편이에요"),
...
AXIS_TO_WEIGHT = {
    ...
    "VQ": {"녹지": -1.0, "상권": 1.3, "문화": 0.8, "안전": -0.6, "교통": 0.5},
...
LEXICON = {
    ...
    "모임": {"EI": 1, "TP": 2}, "번화가": {"EI": 1, "VQ": 2},
    "집순이": {"EI": -2}, "집돌이": {"EI": -2}, "집콕": {"EI": -2},
    "집에서": {"EI": -2}, "넷플": {"EI": -2}, "귀가": {"EI": -1},
    "재택": {"EI": -1, "WD": 1},

    # 번화한 ↔ 조용한
    "쇼핑": {"VQ": 2, "EI": 1}, "맛집": {"VQ": 2, "WD": 1},
    "카페": {"VQ": 1, "EI": 1}, "역세권": {"VQ": 2, "WD": 1},
    "지하철": {"VQ": 1, "WD": 1}, "밤늦": {"VQ": 1, "EI": 1},
    "화려": {"VQ": 2},
    "조용": {"VQ": -2}, "한적": {"VQ": -2}, "고요": {"VQ": -2, "TP": -1},
    "소음": {"VQ": -2}, "시끄": {"VQ": -2}, "공원": {"VQ": -1, "EI": 1},
    "산책": {"VQ": -1, "WD": 2}, "숲": {"VQ": -2}, "자연": {"VQ": -2},
    "녹지": {"VQ": -2},
...
def describe(axis: dict) -> list:
    ...
    PHRASE = {
        ...
        "VQ": ("북적이는 곳을 편하게 느끼며", "조용한 주거지를 선호하며"),
